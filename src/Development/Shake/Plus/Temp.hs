...
-- | Lifted version of `Development.Shake.withTempFile` with well-typed `Path`.
...
-- | Lifted version of `Development.Shake.withTempFileWithin` with well-typed `Path`s.
...
-- | Lifted version of `Development.Shake.withTempDirWithin` with well-typed `Path`s.
